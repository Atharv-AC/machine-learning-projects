...
A curated collection of **end-to-end Machine Learning projects** built using Python and scikit-learn.
This repository demonstrates the complete ML workflow—from **data preprocessing** to **model training, evaluation, visualization, and prediction**.
